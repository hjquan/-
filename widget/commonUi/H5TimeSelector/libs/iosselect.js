	...
	IosSelect.prototype = {
		...
		setScorllEvent: function (scrollInstance, index) {
			...
			scrollInstance.on('scrollEnd', function () {
				...
				self.options.scrollback && self.options.scrollback(self.selectOneObj, self.selectTwoObj, self.selectThreeObj, self.selectFourObj, self.selectFiveObj, self.selectSixObj);
			});
